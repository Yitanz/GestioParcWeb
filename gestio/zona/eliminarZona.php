        ...
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <ul class="nav flex-column collapse show" id="submenu7" data-parent="#sidebar">
              ...
              <li class="nav-item">
                <a class="nav-link nav-interior" href="../zona/modificarZona.php"><span data-feather="edit"></span>Modificar Zona</a>
              </li>
              <li class="nav-item">
                <a class="nav-link nav-interior active" href="../zona/eliminarZona.php"><span data-feather="minus-square"></span>Eliminar Zona</a>
              </li>
            </ul>
          </ul>
        </div>
