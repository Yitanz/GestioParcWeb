...
<div class="container jumbotron" style="margin-top:30px">
  <div class="row">
      <div class="col-sm-12">
        <h3 class="font-weight-bold text-center text-uppercase">COMPRA ELS TEUS TICKETS</h3>
      </div>
    </div>
  <br>
  ...
  <div class="row">
    <div class="col-sm-3">
      <div class="form-group">
        <a class="nav-link" href="ticket.php">
          <img src="/img/tickets/GENERAL.jpg" width="100%">
        </a>
      </div>
    </div>
    ...
    <div class="col-sm-3">
      <div class="form-group">
        <a class="nav-link" href="ticketExpress.php">
          <img src="/img/tickets/EXPRESS.jpg" width="100%">
        </a>
      </div>
    </div>
    ...
    <div class="col-sm-3">
      <div class="form-group">
        <a class="nav-link" href="ticketx3.php">
          <img src="/img/tickets/X3.jpg" width="100%">
        </a>
      </div>
    </div>
    ...
    <div class="col-sm-3">
      <div class="form-group">
        <a class="nav-link" href="ticketx5.php">
          <img src="/img/tickets/X5.jpg" width="100%">
        </a>
      </div>
    </div>
