        ...
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <ul class="nav flex-column collapse" id="submenu1" data-parent="#sidebar">
              <li class="nav-item">
                <a class="nav-link nav-interior" href="c#"><span data-feather="user-plus"></span>Crear Client</a>
              </li>
              <li class="nav-item">
            ...
            <ul class="nav flex-column collapse show" id="submenu7" data-parent="#sidebar">
              ...
              <li class="nav-item">
                <a class="nav-link nav-interior" href="../zona/llistarZona.php"><span data-feather="file-text"></span>Llistar Zones</a>
              </li>
              <li class="nav-item">
                <a class="nav-link nav-interior active" href="../zona/modificarZona.php"><span data-feather="edit"></span>Modificar Zona</a>
              </li>
              <li class="nav-item">
                <a class="nav-link nav-interior" href="../zona/eliminarZona.php"><span data-feather="minus-square"></span>Eliminar Zona</a>
              </li>
            </ul>
          </ul>
        </div>
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <form class="needs-validation" action="#">
          <div class="form-row">
            ...
            <div class="col-md-3 mb-3">
              <label for="validationCustom02">Superficie (m2) *</label>
              <input type="text" class="form-control form-control-sm" placeholder="Superficie" required>
            </div>
            <div class="col-md-3 mb-3">
              <label for="validationCustom02">Aforament *</label>
              <input type="text" class="form-control form-control-sm" placeholder="Aforament">
            </div>
          </div>
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Modificar zones de forma massiva</h1>
        </div>
        ...
        <form>
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-3 mb-3">
                <label for="exampleFormControlFile1">Pujar arxiu .CSV amb dades de les zones</label>
