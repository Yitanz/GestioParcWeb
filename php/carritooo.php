...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark py-4">
  ...
  <div class="container">
      ...
      <div id="products" class="row list-group">
          ...
          //get rows query
          $query = $connection->query("SELECT * FROM products WHERE not (tipus_producte like 'ticket%') ORDER BY id DESC LIMIT 10");
          if($query->num_rows > 0){
  ...
  <!-- MODAL -->
      ...
      <div class="modal fade" id="afegirCistella" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                  <div class="modal-content">
                   <div class="form-group row">
                   <label class="col-12 ">Vols continuar comprant?</label>
                 </div>
                    <div class="modal-footer">
                      <input type="submit" class="btn btn-primary" name="cistella" value="Anar    a la cistella">
                      <button type="sumbit" class="btn btn-secondary" >Continuar comprant</button>
                    </div>
                  </form>
                  </div>
                </div>
