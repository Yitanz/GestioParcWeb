        ...
        <div class="col-sm-12">
          ...
          <div class="row">
            <div class="col-4">
              ...
              <input type="month" id="start" name="targeta_caducitat" required></input>
            </div>
            <div class="col-4 ">
              <label>Codi Secret</label>
              <input type="text" id="start" name="targeta_codi_secret" required></input>
            </div>
              <div class="col-4">
              <label>Titular</label>
              <input type="text" id="start" name="targeta_titular"></input>
            </div>
          </div>
        </div>
          <button type="submit" class="btn btn-primary">Finalitzar Pagament</button>
      </form>
    </div>
    </div>
  </div>
