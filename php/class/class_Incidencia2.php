...
class Incidencia {
  ...
  function __construct7($titol_incidencia_parc, $descripcio_incidencia_parc, $prioritat_incidencia_parc, $data_inici_incidencia_parc, $data_fi_incidencia_parc, $id_estat, $id_usuari_client, $id_usuari_empleat){
    ...
    $this->id_usuari_client = $id_usuari_client;
    $this->id_usuari_empleat = $id_usuari_empleat;
  }
