    ...
    <div class="row">
        ...
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <ul class="nav flex-column collapse" id="submenu5" data-parent="#sidebar">
              ...
              <li class="nav-item">
                <a class="nav-link nav-interior" href="../incidencia/ldarIncidencia.html"><span data-feather="file-text"></span>Llistar Inicidències</a>
              </li>
              <li class="nav-item">
            ...
            <ul class="nav flex-column collapse show" id="submenu7" data-parent="#sidebar">
              <li class="nav-item">
                <a class="nav-link nav-interior active" href="../zona/crearZona.php"><span data-feather="plus-square"></span>Crear Zona</a>
              </li>
              <li class="nav-item">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Crear zona</h1>
        </div>

        <form method="post" action="/php/registrar_zona.php" class="needs-validation" action="#">
          <div class="form-row">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Crear zones de forma massiva</h1>
        </div>
